...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Isaac McQueen"
    user-mail-address "imcqueen@truehomesusa.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/imcquee/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/imcquee/bin" "/profile/bin" "/Users/imcquee/.npm-packages/bin" "/Users/imcquee/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
